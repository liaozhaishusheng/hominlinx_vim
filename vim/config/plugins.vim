...
"NERD-Tree 记住插件的快捷键 一款文件浏览器，可查看文件目录结构打开相应的文件。
...
let g:ctrlp_mruf_max=50                    "  指定你希望CtrlP记录的最近打开的文件历史的数目
...
let g:ycm_enable_diagnostic_signs=0                          " 关闭语法检测
let g:ycm_complete_in_comments=1                             " 注释输入时补全
